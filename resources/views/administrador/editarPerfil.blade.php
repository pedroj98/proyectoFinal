            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 my-5">
                <div class="card">
                    <div class="row">
                        ...
                        <div class="col-lg-6 md-6"><a href="/administrador/restaurantes"><img src="{{url('/media/logo.png')}}"></a></div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="/administrador/actualizar/{{Auth::user()->id}}" id="editarCliente" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
