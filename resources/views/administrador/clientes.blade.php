                    ...
                    <table class="table table-striped table-bordered first text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ URL::to('/') }}/images/{{ $cliente->imagen }}" width="50" height="50" /></td>
                                <td><a href="/administrador/clientes/eliminar/{{$cliente->id}}"><i class="fas fa-trash-alt text-danger m-2"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
