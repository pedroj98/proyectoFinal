...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Crear Proveedor</h2>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
        <div class="card">
            ...
            @if($errors->any())
                ...
                @endif
                <form action="/administrador/proveedores/añadir/" id="crearProveedor" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                            ...
                            <input id="pais" type="text" name="pais" data-parsley-trigger="change" required class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                            ...
                            <input id="email" type="email" name="email" data-parsley-trigger="change" required class="form-control">
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                            <label for="telefono">Telefono:</label>
                            <input id="telefono" type="tel" name="telefono" data-parsley-trigger="change" required class="form-control">
                        </div>
                    </div>
